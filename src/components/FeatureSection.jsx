...
function FeatureSection() {
  return (
    <div id="features">
      <div className="mt-24">
        <h1 className=" text-3xl font-bold text-center text-[#05b1ba] md:text-6xl">
          {" "}
          NEXUM now on:
        </h1>
      ...
      <div className="mt-15 mx-4">
        <p className=" text-[#00f0c4] text-2xl pl-8 font-bold mb-6 lg:ml-34">
          {" "}
          Dont Miss
        </p>
        <div className=" flex flex-col gap-4 mt-4  md:hidden">
          <div className=" hover:bg-[#012743] cursor-pointer rounded-md mx-8 border  border-[#054776] h-38 flex flex-col md:flex md:w-1/4">
            ...
            <p className=" mt-4 font-extralight ml-4 text-white">
              Our Partnership with Investment <br /> Fund from UAE{" "}
            </p>
          </div>

          <div className=" hover:bg-[#012743] cursor-pointer rounded-md mx-8 border border-[#054776] h-38 flex flex-col md:w-1/4">
            <div className="  mt-6 ml-4 flex gap-2 text-center  items-center">
            ...
            <p className=" mt-4 font-extralight ml-4 text-white">
              Nexum Building Blockchain-based <br /> Carbon Credit Exchange
              Platform
            </p>
          </div>

          <div className=" rounded-md mx-8 cursor-pointer hover:bg-[#012743] border border-[#054776] h-38 flex flex-col md:w-1/4">
            <div className=" mt-6 ml-4 flex  text-center  items-center">
              <FontAwesomeIcon
                className="text-white text-4xl"
                icon={faDroplet}
              />
              <p className=" font-light text-2xl text-[#00a8ec]">
                Publish<span className="font-light text-[#4d4d4d]">0</span>
                <span className="text-[#4d4d4d] text-2xl font-light ">x</span>
              </p>
            </div>
            <p className=" mt-4 font-extralight ml-4 text-white">
              Interview with our CEO about the <br />
              future of Nexum
            </p>
          </div>
        </div>
        ...
        <div className=" hidden md:flex mt-4 lg:ml-34  ">
          <div className=" rounded-md mx-8 hover:bg-[#012743] border   border-[#054776] h-38 flex flex-col md:flex md:w-1/4">
            ...
            <p className=" mt- font-extralight ml-4 text-white">
              Our Partnership with Investment <br /> Fund from UAE{" "}
            </p>
          </div>

          <div className=" rounded-md hover:bg-[#012743] border border-[#054776] h-38 flex flex-col md:w-1/4">
            <div className=" mt-3 flex text-center  items-center">
              <img className="w-8 ml-3" src={Cryptopolitan} alt="" />
              <p className=" text-l text-white font-extrabold">
                {" "}
                Cryptopolitan{" "}
              </p>
            </div>
            <p className=" mt-1 font-extralight ml-4 text-white">
              Nexum Building Blockchain-based <br /> Carbon Credit Exchange
              Platform
            </p>
          </div>

          <div className=" rounded-md mx-8 border hover:bg-[#012743] border-[#054776] h-38 flex flex-col md:w-1/4">
            <div className=" mt-3 ml-4 flex  text-center  items-center">
              <FontAwesomeIcon
                className="text-white text-4xl"
                icon={faDroplet}
        ...
        <div className=" mt-20">
          ...
          <div className="md:hidden flex flex-col gap-4 ml-6 ">
            ...
            <div className="mt-10 md:border border-[#023153] hover:bg-[#012743] rounded-xl md:w-85">
              ...
              <p className="text-center mt-5 text-white font-light">
                The very nature of shipping industry <br />
                presented big challenges that lead to:
              </p>
              <div className="mt-6 flex flex-col gap-6">
                ...
                <div className=" flex mx-6 gap-4">
                  ...
                  <p className="text-white font-light">
                    {" "}
                    Difficulty in coordination within ship managers and between
                    and buyers
                  </p>
                </div>
                ...
                <div className=" flex mx-6 gap-4">
                  ...
                  <p className="text-white font-light">
                    {" "}
                    Financial loses resulted in bankruptcy
                  </p>
                </div>
            ...
            <div className="mt-10 md:border hover:bg-[#012743] border-[#023153] rounded-xl md:w-85">
              ...
              <p className=" mt-5 text-white font-extralight mx-5 text-center">
                Value is created only if you can provide solution for an
                existing problem.
              </p>
              <p className=" mt-5 text-white font-extralight mx-5 text-center">
                Nexum Platform powered by blockchain technology provides the
          ...
          <div className=" rounded-md mx-6 mb-4 mt-10 border cursor-pointer hover:bg-[#012743]  border-[#054776] lg:mx-68">
            <p className=" px-2 text-center font-extralight m py-4 text-white">
              {" "}
              Nexum Platform creates a{" "}
              <span className="font-bold">
                transparent, efficient and cost- <br /> saving ecosystem{" "}
              </span>
              for each player in the Shipping & Oil industry. <br />{" "}
            </p>
          </div>
        </div>
      </div>
