...
function Aboutsection() {
    return (
        <div className='
          ' >
            <div className=' md:hidden flex flex-col gap-4 mt-10'> {/* mobile version */}
                <p className='text-center text-white text-3xl font-semibold px-7'> Unbanking Shipping</p>
                <p className=' text-white text-center px-12 font-extralight'>
                    ...
                    NEXM is designed to <span className='font-bold'>unbank the shipping industry.</span>
                    <br /> <br />
                    We signed the first partnership with <span className='font-bold'>Nexum Platform</span> to provide funding to traders in the shipping and oil industry in a secure and efficient way.
                </p>
                ...
                <p className=' mt-10 text-center text-[#01C09D] '> Low: <span className=' font-bold text-xl text-white'>$0.14819</span></p>
                <p className='text-center text-[#01C09D] '> High: <span className=' font-bold text-xl text-white'>$0.16937</span></p>
     ...
     ' src={Vector} alt="" />
                    ...
                    <div className='flex h-40 mt-4 ml-32 lg:justify-end  '>
                        <div className='  md:w-50 flex flex-col mt-3 gap-0.5 lg:pl-15 lg:mt-5 lg:gap-2' >
                            <p className=' md:mt-3 text-[#01C09D] lg:mt-2.5 '> Low: <span className='  text-white font-medium'>$0.14819</span></p>
                            <p className='text-[#01C09D] mb-150 lg:mb-30 lg:justify-center '> High:<span className=' text-white font-medium'>$0.16937</span></p>
                        </div>

                        <div className=' w-1/2 lg:w-40 lg: h-25 lg:mt-2 flex flex-col gap-2 justify-center'>
                            <img className=' px-3 ' src={Hrs} alt="" />
                            <p className=' px-2 text-l text-white font-medium'>$218,929.60 </p>
                        </div>
